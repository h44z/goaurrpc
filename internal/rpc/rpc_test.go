...
var conf = config.Settings{
	...
	MaxResults:               5000,
	RefreshInterval:          config.NewDurationInSeconds(600),
	RateLimit:                4000,
	RateLimitCleanupInterval: config.NewDurationInSeconds(600),
	LoadFromFile:             true,
	TrustedReverseProxies:    []string{"127.0.0.1", "::1"},
	EnableSearchCache:        true,
	CacheCleanupInterval:     config.NewDurationInSeconds(60),
	CacheExpirationTime:      config.NewDurationInSeconds(300),
	RateLimitTimeWindow:      config.NewDurationInSeconds(86400),
	LogFile:                  "/tmp/log.tst",
	EnableMetrics:            true,
	EnableAdminApi:           true,
	AdminAPIKey:              "test",
...
func (suite *RpcTestSuite) SetupSuite() {
	...
	suite.ExpectedRpcResults = map[string]responseResult{
		...
		"/rpc?v=5&type=multiinfo&arg=attest": {
			`{"resultcount":1,"results":[{"CheckDepends":["acyclovir","severals"],"Conflicts":["georginas","craw","lift"],"Description":"This is a desciptive text for package attest","FirstSubmitted":1644749267,"ID":25746,"Keywords":[],"LastModified":1644749267,"License":[],"Maintainer":"violate","MakeDepends":["answerable","ingrained","circumscribed","crust","landsats","emptier"],"Name":"attest","NumVotes":42,"OptDepends":["lowermost: for unanswered","racquetballs: for ornaments","slit: for dichotomy"],"OutOfDate":null,"PackageBase":"attest","PackageBaseID":25746,"Popularity":0,"Provides":["superber","acupuncture","destination","rota","shoeshine"],"Replaces":["brutishness","messaged","abut"],"URL":null,"URLPath":"/cgit/aur.git/snapshot/attest.tar.gz","Version":"2.11.73-4"}],"type":"multiinfo","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=info&arg=doesnotexist": {
			`{"resultcount":0,"results":[],"type":"multiinfo","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=info&arg=x": {
			`{"resultcount":0,"results":[],"type":"multiinfo","version":5}`,
			consts.ContentTypeJson,
		},
		...
		"/rpc?v=5&type=search&arg=at": {
			`{"error":"Too many package results.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		...
		"/rpc?v=5&type=suggest&arg=at": {
			`["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=suggest&arg=": {
			`["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=suggest&arg=attest": {
			`["attest","attestation","attestations","attested","attesting","attests"]`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=suggest&arg=test": {`[]`, consts.ContentTypeJson},
		"/rpc?v=5&type=suggest-pkgbase&arg=attest": {
			`["attest","attestation","attestations","attested","attesting","attests"]`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=suggest-pkgbase&arg=aTTest": {
		...
		"/rpc?v=5&type=suggest-pkgbase&arg=at": {
			`["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=suggest-pkgbase&arg=": {
			`["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=suggest-pkgbase&arg=test": {`[]`, consts.ContentTypeJson},
		"/rpc?v=5&type=opensearch-suggest&arg=at": {
			`["at",["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]]`,
			consts.ContentTypeOSS,
		},
		"/rpc?v=5&type=opensearch-suggest&arg=": {
			`["",["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]]`,
			consts.ContentTypeOSS,
		},
		"/rpc?v=5&type=opensearch-suggest&arg=attest": {
			`["attest",["attest","attestation","attestations","attested","attesting","attests"]]`,
			consts.ContentTypeOSS,
		},
		"/rpc?v=5&type=opensearch-suggest&arg=test": {`["test",[]]`, consts.ContentTypeOSS},
		"/rpc?v=5&type=opensearch-suggest-pkgbase&arg=attest": {
			`["attest",["attest","attestation","attestations","attested","attesting","attests"]]`,
			consts.ContentTypeOSS,
		},
		"/rpc?v=5&type=opensearch-suggest-pkgbase&arg=aTTest": {
		...
		"/rpc?v=5&type=opensearch-suggest-pkgbase&arg=at": {
			`["at",["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]]`,
			consts.ContentTypeOSS,
		},
		"/rpc?v=5&type=opensearch-suggest-pkgbase&arg=": {
			`["",["attest","attestation","attestations","attested","attesting","attests","attic","atticas","attics","attila","attire","attired","attires","attitude","attitudes","attitudinal","attitudinize","attitudinized","attitudinizing","attlee"]]`,
			consts.ContentTypeOSS,
		},
		"/rpc?v=5&type=opensearch-suggest-pkgbase&arg=test": {`["test",[]]`, consts.ContentTypeOSS},
		"/rpc?v=5&type=search&by=depends&arg=chrystals": {
		...
		"/rpc/v5/search/chrystals?by=depends": {
			`{"resultcount":1,"results":[{"Description":"This is a desciptive text for package attics","FirstSubmitted":1644749267,"ID":6877,"LastModified":1644749267,"Maintainer":"supergrasses","Name":"attics","NumVotes":42,"OutOfDate":null,"PackageBase":"attics","PackageBaseID":6877,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attics.tar.gz","Version":"8.5-10"}],"type":"search","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=depends&arg=x": {
			`{"error":"Query arg too small.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=optdepends&arg=bhopal": {
		...
		"/rpc?v=5&type=search&by=optdepends&arg=x": {
			`{"error":"Query arg too small.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=makedepends&arg=constructive": {
		...
		"/rpc?v=5&type=search&by=makedepends&arg=x": {
			`{"error":"Query arg too small.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		...
		"/rpc?v=5&type=search&by=checkdepends&arg=x": {
			`{"error":"Query arg too small.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc/?v=5&type=search&by=provides&arg=scrumpy": {
		...
		"/rpc/?v=5&type=search&by=replaces&arg=spangled": {
		...
		"/rpc/?v=5&type=search&by=groups&arg=nothing": {
			`{"resultcount":1,"results":[{"Description":"This is a desciptive text for package backwoodsmans","FirstSubmitted":1644749267,"ID":6308,"LastModified":1644749267,"Maintainer":"sss","Name":"backwoodsmans","NumVotes":46,"OutOfDate":null,"PackageBase":"backwoodsmans","PackageBaseID":6308,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/backwoodsmans.tar.gz","Version":"9.8.61-4"}],"type":"search","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc/?v=5&type=search&by=nonsense&arg=nothing": {
			`{"error":"Incorrect by field specified.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=name&arg=attest": {
			`{"resultcount":6,"results":[{"Description":"This is a desciptive text for package attest","FirstSubmitted":1644749267,"ID":25746,"LastModified":1644749267,"Maintainer":"violate","Name":"attest","NumVotes":42,"OutOfDate":null,"PackageBase":"attest","PackageBaseID":25746,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attest.tar.gz","Version":"2.11.73-4"},{"Description":"This is a desciptive text for package attestation","FirstSubmitted":1644749269,"ID":75661,"LastModified":1644749269,"Maintainer":null,"Name":"attestation","NumVotes":39,"OutOfDate":null,"PackageBase":"attestation","PackageBaseID":75661,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attestation.tar.gz","Version":"4.18.64-2"},{"Description":"This is a desciptive text for package attestations","FirstSubmitted":1644749269,"ID":74902,"LastModified":1644749269,"Maintainer":"gilchrists","Name":"attestations","NumVotes":44,"OutOfDate":null,"PackageBase":"attestations","PackageBaseID":74902,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attestations.tar.gz","Version":"4.9-9"},{"Description":"This is a desciptive text for package attested","FirstSubmitted":1644749268,"ID":71241,"LastModified":1644749268,"Maintainer":null,"Name":"attested","NumVotes":45,"OutOfDate":null,"PackageBase":"attested","PackageBaseID":71241,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attested.tar.gz","Version":"0.2.33-2"},{"Description":"This is a desciptive text for package attesting","FirstSubmitted":1644749268,"ID":67658,"LastModified":1644749268,"Maintainer":"amorphousness","Name":"attesting","NumVotes":51,"OutOfDate":null,"PackageBase":"attesting","PackageBaseID":67658,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attesting.tar.gz","Version":"1.14.65-10"},{"Description":"This is a desciptive text for package attests","FirstSubmitted":1644749268,"ID":42783,"LastModified":1644749268,"Maintainer":"injudicious","Name":"attests","NumVotes":48,"OutOfDate":null,"PackageBase":"attests","PackageBaseID":42783,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/attests.tar.gz","Version":"8.13.74-4"}],"type":"search","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=name&arg=x": {
			`{"error":"Query arg too small.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=maintainer&arg=mistrustful": {
		...
		"/rpc?v=5&type=search&by=maintainer&arg=gibbered": {
			`{"resultcount":1,"results":[{"Description":"This is a desciptive text for package backlog","FirstSubmitted":1644749267,"ID":29230,"LastModified":1644749267,"Maintainer":"giBBered","Name":"backlog","NumVotes":53,"OutOfDate":null,"PackageBase":"backlog","PackageBaseID":29230,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/backlog.tar.gz","Version":"0.12.52-5"}],"type":"search","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=maintainer&arg=gIbbeRed": {
			`{"resultcount":1,"results":[{"Description":"This is a desciptive text for package backlog","FirstSubmitted":1644749267,"ID":29230,"LastModified":1644749267,"Maintainer":"giBBered","Name":"backlog","NumVotes":53,"OutOfDate":null,"PackageBase":"backlog","PackageBaseID":29230,"Popularity":0,"URL":null,"URLPath":"/cgit/aur.git/snapshot/backlog.tar.gz","Version":"0.12.52-5"}],"type":"search","version":5}`,
		...
		"/rpc?v=5&type=search&by=maintainer&arg=x": {
			`{"resultcount":0,"results":[],"type":"search","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&by=maintainer&arg=": {
			`{"error":"Too many package results.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		...
		"/rpc?v=5&type=msearch&arg=mistrustful": {
		...
		"/rpc?v=5&type=nonsense&arg=bla": {
			`{"error":"Incorrect request type specified.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=4&type=search&arg=bla": {
			`{"error":"Invalid version specified.","resultcount":0,"results":[],"type":"error","version":4}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search&arg=a": {
			`{"error":"Query arg too small.","resultcount":0,"results":[],"type":"error","version":5}`,
			consts.ContentTypeJson,
		},
		"/rpc?type=search&arg=a": {
			`{"error":"Please specify an API version.","resultcount":0,"results":[],"type":"error","version":null}`,
			consts.ContentTypeJson,
		},
		"/rpc?v=5&type=search": {
	...
	suite.ExpectedAdminResultsGET = map[string]responseResult{
		"/admin/settings/aur-file-location": {
			`Current setting for 'AurFileLocation' is '../../test_data/test_packages.json'`,
			consts.ContentTypeText,
		},
		"/admin/settings/max-results": {
			`Current setting for 'MaxResults' is '5000'`,
			consts.ContentTypeText,
		},
		"/admin/settings/refresh-interval": {
			`Current setting for 'RefreshInterval' is '600'`,
			consts.ContentTypeText,
		},
		"/admin/settings/rate-limit": {
			`Current setting for 'RateLimit' is '4000'`,
			consts.ContentTypeText,
		},
		"/admin/settings/rate-limit-cleanup-interval": {
			`Current setting for 'RateLimitCleanupInterval' is '600'`,
			consts.ContentTypeText,
		},
		"/admin/settings/rate-limit-time-window": {
			`Current setting for 'RateLimitTimeWindow' is '86400'`,
			consts.ContentTypeText,
		},
		"/admin/settings/cache-cleanup-interval": {
			`Current setting for 'CacheCleanupInterval' is '60'`,
			consts.ContentTypeText,
		},
		"/admin/settings/cache-expiration-time": {
			`Current setting for 'CacheExpirationTime' is '300'`,
			consts.ContentTypeText,
		},
		"/admin/settings/enable-search-cache": {
			`Current setting for 'EnableSearchCache' is 'true'`,
			consts.ContentTypeText,
		},
		"/admin/settings": {
...
func (suite *RpcTestSuite) TestAdminHandlers() {
	...
	suite.srv.router.ServeHTTP(rr, req)
	suite.Nil(err, "Could not create POST request")
	suite.Equal("Reload skipped. Data has not changed", rr.Body.String(),
		"Should return 'Reload skipped. Data has not changed'")
	suite.Equal(http.StatusAccepted, rr.Result().StatusCode)
	suite.Equal(consts.ContentTypeText, rr.Result().Header.Get("Content-Type"))
	...
	suite.srv.router.ServeHTTP(rr, req)
	suite.Nil(err, "Could not create POST request")
	suite.Equal("db-file error for nonsense: stat nonsense: no such file or directory", rr.Body.String(),
		"Should return 'stat nonsense: no such file or directory'")
...
func (suite *RpcTestSuite) TestListen() {
	suite.srv.conf.RateLimitCleanupInterval = config.NewDurationInSeconds(1)
	suite.srv.conf.RefreshInterval = config.NewDurationInSeconds(1)
	suite.srv.conf.CacheCleanupInterval = config.NewDurationInSeconds(1)
	suite.srv.conf.CacheExpirationTime = config.NewDurationInSeconds(1)
	suite.srv.lastRefresh = time.Time{}
